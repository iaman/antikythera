...
describe("Antikythera", function() {
  ...
  describe("crank", function() {
    ...
    it("logs the transition if the Antikythera is in the present", function() {
      this.blah.go("stuff");
      this.blah.crank();
      return expect(this.blah.history.length).toEqual(1);
    });
  ...
  describe("go", function() {
    ...
    it("queues a transition up if the Antikythera is in dev mode", function() {
      ...
      this.blah.go("stuff");
      return expect(this.blah._queue).toHaveBeenCalledWith("stuff", -1, void 0);
    });
  ...
  describe("reverse", function() {
    ...
    it("returns false if there's no history", function() {
      return expect(this.blah.reverse()).toBeFalsy;
    });
    it("returns false if the Antikythera is not in development mode", function() {
    ...
    it("fires off a transition with the data that was originally passed into it", function() {
      ...
      this.blah.crank();
      this.blah.reverse();
      return expect(this.blah._transition.calls[1].args).toEqual([
        {
          name: "things",
    ...
    return it("decrements the Antikythera's position", function() {
      this.blah.go("stuff");
      this.blah.crank();
      expect(this.blah.position).toEqual(0);
      this.blah.reverse();
  ...
  describe("_log", function() {
    ...
    it("logs the data for a transition", function() {
      expect(this.blah.history[0].dataIn).toEqual("hello");
      expect(this.blah.history[0].dataOut).toEqual("goodbye");
      expect(this.blah.history[0].position).toEqual(0);
      expect(this.blah.history[0].transitionedOut).toEqual({
        name: "default"
      });
      return expect(this.blah.history[0].transitionedIn).toEqual({
        name: "stuff",
        transitionIn: transitionIn,
        transitionOut: transitionOut
      });
  ...
  describe("_queue", function() {
    ...
    return it("automatically sorts transitions by their position in history", function() {
      ...
      this.blah._queue("things", -1, void 0);
